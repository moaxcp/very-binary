...
public sealed abstract class BasicListType<SELF extends ListType<SELF, T, L>, T, L extends BinaryList<L, T>> extends ListType<SELF, T, L> permits PrimitiveListType, Uint64ListType {
