...
public final class BoolType extends PrimitiveType<BoolType, Boolean> {
  ...
  public BoolType(int position, @Nullable ComplexType<?> parent, @Nullable Boolean constantValue) {
    super(position, parent, BOOL);
  ...
  public BoolType copy(int position, @Nullable ComplexType<?> parent) {
    return new BoolType(position, parent, constantValueSet ? constantValue : null);
  }
