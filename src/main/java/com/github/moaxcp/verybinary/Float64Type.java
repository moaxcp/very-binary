...
public final class Float64Type extends PrimitiveType<Float64Type, Double> implements LengthType<Float64Type, Double> {
  ...
  public Float64Type(int position, @Nullable ComplexType<?> parent, @Nullable Double constantValue) {
    super(position, parent, FLOAT64);
  ...
  public Float64Type copy(int position, @Nullable ComplexType<?> parent) {
    return new Float64Type(position, parent, constantValueSet ? constantValue : null);
  }
