...
public final class Int16Value extends ArithmeticValue {
  final short value;
  ...
  private Int16Value(int value) {
    this.value = (short) value;
  }

  public static Int16Value int16Value(short value) {
    return new Int16Value(value);
  }

  public static Int16Value int16Value(int value) {
    return new Int16Value(value);
  }
