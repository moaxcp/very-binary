...
public final class Uint32Value extends ArithmeticValue {
  ...
  public ArithmeticValue sum(ArithmeticValue other) {
    return switch (other) {
      ...
      case Int8Value v -> uint32Value(value + v.value);
      case Int16Value v -> uint32Value(value + v.value);
      case Int32Value v -> uint32Value(value + v.value);
  ...
  public boolean equals(Object o) {
    ...
    Uint32Value other = (Uint32Value) o;
