...
public final class Uint8Value extends ArithmeticValue {
  final short value;

  private Uint8Value(short value) {
    this.value = value;
  }

  private Uint8Value(int value) {
    this.value = (short) value;
  }

  public static Uint8Value uint8Value(short value) {
    return new Uint8Value(value);
  }

  public static Uint8Value uint8Value(int value) {
    return new Uint8Value(value);
  }
