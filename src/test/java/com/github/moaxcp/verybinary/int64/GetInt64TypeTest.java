...
public class GetInt64TypeTest {
  ...
  void getArrayWrapper() {
    ...
    assertThatThrownBy(() -> ((Int64ListType) struct.getType(1)).get(struct, 0))
        .isInstanceOf(UnsupportedOperationException.class)
        .hasMessage("get(Pointer, long) not supported for Int64ListType. Use getInt64(Pointer, long) instead.");
  }
  ...
  void getInt64Array_negative() {
    ...
    assertThatThrownBy(() -> struct.getInt64(1, -1))
        ...
        .hasMessage("Int64ListType at position 1 index: -1 length: 0");
  }
  ...
  void getInt64Array_greater_than_length() {
    ...
    assertThatThrownBy(() -> struct.getInt64(1, 2))
        .isInstanceOf(ArrayIndexOutOfBoundsException.class)
        .hasMessage("Int64ListType at position 1 index: 2 length: 2");
  }
