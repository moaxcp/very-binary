...
public class RemoveUint16TypeTest {
  ...
  void removeUint16_with_index_0() {
    ...
    assertThat(((Uint16ListType) struct.getType(1)).getUint16(struct, 0)).isEqualTo(2);
  ...
  void removeUint16_with_index_negative() {
    ...
    assertThatThrownBy(() -> struct.remove(1, -1))
        ...
        .hasMessage("Uint16ListType at position 1 index: -1 length: 2");
  }
  ...
  void removeUint16_with_index_greater_than_length() {
    ...
    assertThatThrownBy(() -> struct.remove(1, 2))
        .isInstanceOf(ArrayIndexOutOfBoundsException.class)
        .hasMessage("Uint16ListType at position 1 index: 2 length: 2");
  }
  ...
  void removeUint16Array_fixed_length() {
    ...
    assertThatThrownBy(() -> struct.remove(0))
        .isInstanceOf(UnsupportedOperationException.class)
        .hasMessage("Cannot remove element from fixed length Uint16ListType at position 0");
  }
  ...
  void removeUint16Array_fixed_length_with_index() {
    ...
    assertThatThrownBy(() -> struct.remove(0, 3))
        .isInstanceOf(UnsupportedOperationException.class)
        .hasMessage("Cannot remove element from fixed length array Uint16ListType at position 0 index: 3");
  }
}
